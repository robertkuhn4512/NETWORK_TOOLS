...
# Normalize PRIMARY_SERVER_FQDN and build common hostnames
PRIMARY_SERVER_FQDN="${PRIMARY_SERVER_FQDN:-networkengineertools.com}"
PRIMARY_SERVER_FQDN="${PRIMARY_SERVER_FQDN#https://}"
PRIMARY_SERVER_FQDN="${PRIMARY_SERVER_FQDN#http://}"
PRIMARY_SERVER_FQDN="${PRIMARY_SERVER_FQDN%/}"
[[ -n "${PRIMARY_SERVER_FQDN}" ]] || PRIMARY_SERVER_FQDN="networkengineertools.com"

FQDN="${PRIMARY_SERVER_FQDN}"
FQDN_VAULT="vault.${FQDN}"
FQDN_AUTH="auth.${FQDN}"
FQDN_API="api.${FQDN}"
FQDN_PGADMIN="pgadmin.${FQDN}"
...
if [[ -n "${PRIMARY_VAULT_SERVER_FQDN_FULL:-}" ]]; then
  ...
  PREFERRED_VAULT_HOST="${FQDN_VAULT}"
fi
...
KEYCLOAK_HOSTNAME="${KEYCLOAK_HOSTNAME:-${FQDN_AUTH}}"
